    ...
    <div className="min-h-screen bg-sage-100">
      <header className="border-b border-sage-200 bg-white px-6 py-4">
        <div className="mx-auto flex max-w-5xl items-center justify-between gap-2">
          <div className="flex min-w-0 flex-1 items-center gap-2 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            ...
            <span className="text-sage-400">/</span>
            <span className="text-sm font-semibold text-sage-900">订单管理</span>
          </div>
      ...
      <main className="mx-auto max-w-5xl px-6 py-8">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-xl font-semibold text-sage-900">订单管理</h1>
          <span className="text-sm text-sage-500">共 {orders.length} 笔订单</span>
        </div>
